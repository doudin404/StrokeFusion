...
If you don't have the datasets yet, you can download them from the official sources or use our pre-packaged versions available on Hugging Face at **[doudin404/stroke_fusion](https://huggingface.co/doudin404/stroke_fusion)**:
...
Pre-trained checkpoints for both models are available to download from Hugging Face at **[doudin404/stroke_fusion](https://huggingface.co/doudin404/stroke_fusion)**.
