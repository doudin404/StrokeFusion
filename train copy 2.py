...
if __name__ == '__main__':
    ...
    dm = StrokesDataModule(
        root_dir=data_dir,
        cache_dir=save_dir,
        data_name="quick_draw/chair",               # 子文件夹名#############################
    ...
    checkpoint_callback.CHECKPOINT_NAME_LAST = "last_chair"
    ...
    last_ckpt = "checkpoints/ready/best_chair.ckpt"#"checkpoints/best_tu_berlin.ckpt"
